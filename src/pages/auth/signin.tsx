...
import { DefaultLayout } from '~/components/DefaultLayout'; // Assuming a default layout exists
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              >
                {/* Basic SVG for Google icon - replace with a proper icon if available */}
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
...
// Add getLayout if your app uses per-page layouts and you want DefaultLayout
